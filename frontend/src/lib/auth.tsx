...
export function SessionProvider({ children }: { children: ReactNode }) {
	...
	const [passwordSetupCurrentPassword, setPasswordSetupCurrentPasswordState] =
		useState<string | null>(() => getPasswordSetupCurrentPassword());
	...
	const signIn = useCallback(
		(
			nextUser: StoredUser,
			nextPasswordSetupCurrentPassword?: string | null,
		) => {
			setUser(nextUser);
